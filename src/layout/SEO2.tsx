    ...
    return (
      <>
        <Head>
          ...
          <meta
            name="keywords"
            content="dust2 train mirage inferno cobblestone overpass cache nades flashbang smoke incendiary molotov grenade csgo cs:go counter-strike global offensive"
          />
